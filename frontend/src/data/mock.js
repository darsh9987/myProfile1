...
export const portfolioData = {
  ...
  contact: {
    ...
    description: "Ready to tackle your next technical challenge? I'm passionate about creating solutions that drive business success and would love to discuss how we can work together.",
    cta: "Start the Conversation",
    availability: "Available for consulting projects, technical leadership roles, and enterprise solution architecture opportunities in Pune and globally."
  }
};
